...
export const products = [
  ...
  {
    _id: "aaaad",
    name: "Men Round Neck PurA lightweight, usually knitted, pullover shirt, close-fitting and with a round neckline and short sleeves, worn as an undershirt or outer garmente Cotton T-shirt",
    description: ".",
    price: 110,
    image: [p_img4],
    category: "Men",
